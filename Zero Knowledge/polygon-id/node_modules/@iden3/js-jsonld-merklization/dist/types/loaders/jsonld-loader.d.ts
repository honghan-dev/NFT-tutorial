...
export declare class JsonLDLoader {
    ...
    httpAgent: any;
    httpsAgent: any;
    constructor(secure?: boolean, strictSSL?: boolean, maxRedirects?: number, headers?: {});
    loadDocument(url: string, redirects?: string[]): any;
}
export declare const getJsonLdDocLoader: () => (url: Url, callback: (err: Error, remoteDoc: RemoteDocument) => void) => Promise<RemoteDocument>;
export declare const jsonLdDocLoader: (url: Url, callback: (err: Error, remoteDoc: RemoteDocument) => void) => Promise<RemoteDocument>;
